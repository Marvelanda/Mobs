...
async function seedPlaces() {
  ...
  const m2 = new Place({
    ...
    placePhotoUrl:
      'https://commondatastorage.googleapis.com/comslider/target/users/1530028052xdb4668343955a27004db2be9d18b76fc/img/180626191824130.jpg?1530030439',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
  ...
  const m3 = new Place({
    ...
    placePhotoUrl:
      'https://regions.kidsreview.ru/sites/default/files/styles/oww/public/08/09/2017-1438/tridevyatoe.jpg',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
  ...
  const m4 = new Place({
    ...
    placePhotoUrl:
      'https://st3.restorating.ru/upload/images/2018/03/27/41d0482e04.jpg',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
  ...
  const m6 = new Place({
    ...
    placePhotoUrl:
      'https://api.parkseason.ru/images/styles/690_auto/bd/b5/51c588232772f75eee96d6e9e6616a5c575aa85098aa8657507145.jpg',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
  ...
  const m8 = new Place({
    ...
    placePhotoUrl:
      'https://rosakhutor.com/upload/iblock/6b3/6b3184c36d18fc1beaabcd63d97b5d44.jpg',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
  ...
  const m10 = new Place({
    ...
    placePhotoUrl:
      'https://www.shopsart.ru/wp-content/uploads/2019/02/mebel-dlya-kafe-barov-restoranov-0003.jpg',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
  ...
  const m11 = new Place({
    ...
    placePhotoUrl:
      'https://www.regberry.ru/sites/default/files/content/images/node/skolko-stoit-otkryt-kafe-s-nulya.png',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
  ...
  const m12 = new Place({
    ...
    placePhotoUrl:
      'https://gcdn.tomesto.ru/img/place/000/021/367/kafe-ermak-na-prospekte-imeni-gazety-krasnoyarskiy-rabochiy_6c249_full-111585.jpg',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
  ...
  const m13 = new Place({
    ...
    placePhotoUrl:
      'https://image2.yell.ru/imager/ODUwODBiODBmNWQyNmNhYThmM/480x240/responses/7/6/0/r_karaoke-klub-7-sky-12053137-i1g86mxzev_1598637768.jpg',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
  ...
  const m15 = new Place({
    ...
    placePhotoUrl:
      'https://media-cdn.tripadvisor.com/media/photo-s/09/48/05/11/caption.jpg',
    description: 'Это секретное место для нормальных типов',
    info: {
      address: 'Площадь Ильича',
      tel: '777-77-77',
